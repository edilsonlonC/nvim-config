...
"vue
let g:coc_node_path = '/home/eddylson/.nvm/versions/node/v20.17.0/bin/node'
"multi cursors
...
let g:SuperTabDefaultCompletionType = '<c-n>'
let g:SuperTabCompletionType = '<c-n>'
"search
...
let g:neotest_adapters = {
			\ 'jest': {}
			\ }
let g:neotest_jest_command = 'jest --runInBand'
let g:neotest_php_command = 'phpunit'  
